      ...
      <main className="roi-wrap">
        ...
        <div className="roi-card">
          ...
          <div className="roi-disclaimer">
            This tool provides estimates for informational purposes only and does not guarantee income outcomes. ROI projections are based entirely on user-provided inputs and should be treated as illustrative rather than predictive. This site may use cookies and analytics. By using this site, you agree to our Privacy Policy and Terms of Service.
